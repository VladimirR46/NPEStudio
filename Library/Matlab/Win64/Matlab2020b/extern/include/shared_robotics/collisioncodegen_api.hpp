...
typedef void *CollisionGeometryType;
 ...
 */
EXTERN_C COLLISIONCODEGEN_API CollisionGeometryType collisioncodegen_makeBox(double x, double y, double z);
 ...
 * @return A void pointer to an instance  of CollisionGeometry
 */
EXTERN_C COLLISIONCODEGEN_API CollisionGeometryType collisioncodegen_makeSphere(double r);
 ...
 * @return A void pointer to an instance  of CollisionGeometry
 */
EXTERN_C COLLISIONCODEGEN_API CollisionGeometryType collisioncodegen_makeCylinder(double r, double h);
 ...
 * @return A void pointer to an instance  of CollisionGeometry
 */
EXTERN_C COLLISIONCODEGEN_API CollisionGeometryType collisioncodegen_makeMesh(double *vertices,
                                                                              double numVertices);
 ...
 */
EXTERN_C COLLISIONCODEGEN_API int collisioncodegen_intersect(CollisionGeometryType obj1,
                              double* pos1, 
                              double* quat1,
