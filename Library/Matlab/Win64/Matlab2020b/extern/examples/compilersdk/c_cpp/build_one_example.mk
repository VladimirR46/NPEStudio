...
C_TARGET_TO_ECHO := $(call convert-pathsep,$(C_TARGET))
MWARRAY_CPP_TARGET_TO_ECHO := $(call convert-pathsep,$(MWARRAY_CPP_TARGET))
MDA_CPP_TARGET_TO_ECHO := $(call convert-pathsep,$(MDA_CPP_TARGET))
